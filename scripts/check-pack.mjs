...
const OWNER_VERSION = '0.1.9'
const OWNER_RELEASE = 'https://github.com/NOirBRight/dsh-llm-providers-ui/releases/download/v0.1.9/dsh-llm-providers-ui-0.1.9.tgz'
const FROZEN_OWNER_FILE = 'dsh-llm-providers-ui-0.1.9-be72be8a1fc7681ac676db0683a1628f1122321fa7c850e42daa35926c108fb8.tgz'
const FROZEN_OWNER_SHA256 = 'be72be8a1fc7681ac676db0683a1628f1122321fa7c850e42daa35926c108fb8'
const FROZEN_OWNER_BYTES = 55027
...
function verifySourceMigration(manifest) {
  for (const section of DEPENDENCY_SECTIONS) {
    for (const [name, spec] of Object.entries(manifest[section] ?? {})) {
      ...
      if (section === 'devDependencies' && name === OWNER_NAME
        && (spec === 'file:../dsh-llm-providers-ui/dsh-llm-providers-ui-0.1.9.tgz'
          || spec === 'file:../dsh-llm-providers-ui/fixtures/alpha4/tarballs/dsh-llm-providers-ui-0.1.9.tgz'
  ...
  if (manifest.devDependencies?.[OWNER_NAME] !== 'file:../dsh-llm-providers-ui/dsh-llm-providers-ui-0.1.9.tgz'
    && manifest.devDependencies?.[OWNER_NAME] !== 'file:../dsh-llm-providers-ui/fixtures/alpha4/tarballs/dsh-llm-providers-ui-0.1.9.tgz'
