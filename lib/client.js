		...
		*/
		...
		function draftOf(settings) {
			return {
				...
				maxTokens: settings.maxTokens === void 0 ? "" : String(settings.maxTokens),
		...
		function settingsOf(draft, current) {
			...
			return {
				...
				...maxTokens === void 0 ? {} : { maxTokens },
				defaultContextWindow: integerOf(draft.defaultContextWindow) ?? NaN,
				streamIdleTimeoutMs: integerOf(draft.streamIdleTimeoutMs) ?? NaN
			};
		}
		...
		function OllamaPluginCard(props) {
			...
			const numbersInvalid = draft !== void 0 && (Number.isNaN(integerOf(draft.defaultContextWindow)) || Number.isNaN(integerOf(draft.maxTokens)) || Number.isNaN(integerOf(draft.streamIdleTimeoutMs)));
			const invalid = draft !== void 0 && (!validURL(draft.baseURL.trim()) || numbersInvalid || modelFailure(draft.models) || keyInvalid);
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												disabled,
												onChange: (event) => {
													patchDraft({ defaultContextWindow: event.target.value });
												}
											})]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
											style: fieldStyle,
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
													...
													disabled,
													onChange: (event) => {
														patchDraft({ maxTokens: event.target.value });
													}
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													style: hintStyle,
													children: t("maxTokensHint")
												})
											]
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											...
											disabled,
											onChange: (event) => {
												patchDraft({ streamIdleTimeoutMs: event.target.value });
											}
										})]
									})
								]
		...
		const en = {
			...
			contextWindow: "Fallback context window",
			maxTokens: "Maximum output tokens",
			maxTokensHint: "Blank uses the provider default.",
			...
			invalidPositiveInteger: "Token and timeout values must be positive integers.",
		...
		const zh = {
			...
			connection: "连接",
			defaults: "请求默认值",
			contextWindow: "后备上下文窗口",
			maxTokens: "最大输出 Tokens",
			maxTokensHint: "留空则使用提供方默认值。",
			streamIdleTimeout: "流式空闲超时（毫秒）",
			models: "模型目录",
			fetchModels: "获取可用模型",
			...
			invalidPositiveInteger: "Token 和超时值必须为正整数。",
		...
		function apply(ctx) {
			...
			const saveConfiguration = async (settings, apiKey) => {
				...
				if (!same(current?.maxTokens, settings.maxTokens)) {
					if (settings.maxTokens === void 0) await scope.unset("maxTokens");
